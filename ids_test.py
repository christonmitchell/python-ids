...
class DetectionEngine:
    def detect_threats(self, features):
        ...
        # SYN flood detection
        if features['flags'] == 'S' and features['dport'] == 80:
            threats.append("Possible SYN flood")

        # Port scan detection
        if features['flags'] == 'S' and features['sport'] in range(4320, 4330):
            threats.append("Possible port scan")
